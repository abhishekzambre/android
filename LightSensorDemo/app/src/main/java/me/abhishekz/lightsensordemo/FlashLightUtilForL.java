 ...
 */
public class FlashLightUtilForL extends Activity {
    private CameraCaptureSession mSession;
    private CaptureRequest.Builder mBuilder;
    private CameraDevice mCameraDevice;


    void FlashLightUtilForL() {
        try {
            init();
    ...
    private void init() throws CameraAccessException {
        mCameraManager = (CameraManager) FlashLightUtilForL.this.getSystemService(Context.CAMERA_SERVICE);
        ...
        if (flashAvailable) {
            ...
            Toast.makeText(FlashLightUtilForL.this, "Flash not available", Toast.LENGTH_SHORT).show();
